...
public class ModMenuTypes {
    public static final MenuType<SpeedCapMenu> SPEEDCAP = Registry.register(BuiltInRegistries.MENU, Identifier.tryBuild(SpeedCap.MOD_ID, "speed_cap"), new MenuType<>(SpeedCapMenu::new, FeatureFlags.VANILLA_SET));
